      ...
      <div>
          ...
          <div className="ml-4 sm:mx-12 md:mx-16 grid grid-cols-12 gap-4 h-auto place-items-center items-center">
            <div className="col-span-12 md:col-span-7 lg:col-span-6 flex flex-col justify-center items-center">
              ...
              <div className="items-center w-3/4 relative">
                ...
                <h1 className="mb-3 mt-6 text-4xl sm:text-2xl md:text-3xl lg:text-2xl xl:text-1xl font-bold text-white leading-none ">
                  Something we have <span className="text-pink font-bold">built.</span>
                </h1>
            ...
            <div className="relative col-span-12 md:col-span-5 lg:col-span-6 flex flex-col">
              ...
              <div className="w-64 h-auto shadow-light-xl hover:shadow-light-3xl transform transition-all duration-300 hover:scale-110">
                <TextCards
                  heading="UI/UX"
                  text="We uses his outstanding engineering abilities to provide users an awesome interface and experience"
                  color="violet"
                />
              </div>
            </div>
        ...
        <div className="relative h-auto sm:h-auto md:h-auto ml-4 sm:mx-12 md:mx-16" id="projects">
          <div className="grid md:grid-cols-3 gap-4 place-items-center">
            {projectDetails?.slice(0, 6)?.map((project: Project) => (
              <ProjectCard
                project={project}
                key={project.slug}
